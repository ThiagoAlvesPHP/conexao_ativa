...
if (!empty($match)) {
	define("BASE", "http://localhost/PROJETOS_ANDAMENTO/conexao_ativa/");
	$config['dbname'] = 'albicod_conexao_ativa';
	$config['host'] = 'localhost';
	$config['dbuser'] = 'root';
	$config['dbpass'] = '';
} else {
	define("BASE", "https://www.albicod.com/conexaoativa/");
	$config['dbname'] = 'albicodc_conexao_ativa';
	$config['host'] = 'localhost';
